...
/* если нужно, изменить размер таблицы
   0 в случае ошибки */
static int _htable_resize(struct htable *tbl) {
...
/* поиск элемента, 0 если не найден */
...
/* удаление элемента, 0 в случае ошибки */
